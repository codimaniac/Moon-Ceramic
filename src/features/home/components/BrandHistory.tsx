  ...
  return (
    <SectionLayout>
        <div className="grid grid-cols-1 min-[820px]:grid-cols-2">
            ...
            <div className="min-[820px]:flex-1 order-2 w-full h-70 bg-cover bg-center" style={{backgroundImage: `url('${ceramicImg[0]}')`}}></div>
            <div className="min-[820px]:flex-1 order-4 min-[820px]:order-3 w-full h-70 bg-cover bg-center" style={{backgroundImage: `url('${ceramicImg[1]}')`}}></div>
